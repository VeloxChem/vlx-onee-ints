...
def write_linear_momentum(ab, flag=''):
    ...
    linmom_ab = LinearMomentum(comp_dict_1[ab[0]], comp_dict_2[ab[1]], 'm')

    flip_ab = False

    # apply HRR on a

    coefs, eris = linmom_ab.apply_hrr_a()
    ...
    for line in final_ints_lines:
        ...
        assert '_LM_00_m ( S S )' not in line
