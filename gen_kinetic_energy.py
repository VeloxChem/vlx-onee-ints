...
"""
    ...
    text += f"""
        ...
        kinetic_energy[ij] = S_ij_00 * (
"""

    text += write_kinetic_energy(f'{a}{b}')
...
"""
    ...
    text += f"""
                ...
                T.row(i_cgto_sph)[j_cgto_sph] += kinetic_energy[ij] * coef_sph;

                {if_str}T.row(j_cgto_sph)[i_cgto_sph] += kinetic_energy[ij] * coef_sph;
            }}
        }}
    }}
"""
